...
const SubscriptionsTable = ({ email, mongoId, date, deleteEmail }) => {
  ...
  return (
    <tr className="bg-white hover:bg-gray-50 transition-colors duration-200 border-b text-left">
      ...
      <td onClick={()=>deleteEmail(mongoId)} className="px-6 py-4 text-red-500 font-semibold cursor-pointer hover:text-red-700">
        ✕
      </td>
    </tr>
  )
